...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'gem: --no-ri --no-rdoc' > /home/deploy/.gemrc
  SHELL


  config.vm.provision "host_shell", inline: <<-SHELL
    ssh-copy-id vagrant@192.168.22.10
    ssh vagrant@192.168.22.10 "sudo cp -rf /home/vagrant/.ssh /home/deploy/ ; sudo chown -R deploy:deploy /home/deploy/.ssh"
  SHELL
